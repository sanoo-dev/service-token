            ...
            <div class="container d-flex justify-content-center">
                <div class="box-center">
                    <form class="frm-general frm-login needs-validation" novalidate>
                        <input type="email" class="form-control mb-3" id="txt-mail" placeholder="Tài khoản" aria-describedby="emailHelp" required>
                        ...
                        <p class="d-flex justify-content-between mt-4">
                            <span class="myf3"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">&nbsp;Ghi nhớ đăng nhập</span>
