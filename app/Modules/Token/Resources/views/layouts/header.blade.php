<header class="mheader">
    <section class="container d-flex flex-column flex-md-row align-items-center pb-3 mb-4">
        ...
        <div class="d-inline-flex mt-2 mt-md-0 ms-md-auto align-items-center">
            @if($_SERVER['REQUEST_URI']== "/token/manage-services"||$_SERVER['REQUEST_URI']== "/token/padding-services")
                <div class="dropdown-center mynav1 active ">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="{{route('viewAcceptService')}}">Chờ Duyệt</a></li>

                        <li><a class="dropdown-item" href="{{route('viewManageService')}}">Danh Sách</a></li>
                    </ul>
                </div>
            @else
            ...
            @endif
            @if($_SERVER['REQUEST_URI']== "/token/manage-endpoints")
                    <div id="header-endpoint" class="dropdown-center mynav1 active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <span class="dropdown-menu-arrow"></span>
                            <li><a class="dropdown-item" href="{{route('viewManageEndPoint')}}">Danh Sách</a></li>
            ...
            <div class="dropdown-center">
                ...
                <ul class="dropdown-menu mmm1" aria-labelledby="dropdownMenuLink">
                    <span class="dropdown-menu-arrow"></span>
                    <li><a class="dropdown-item myf5" href="{{env('URL_ERP','https://erp.tuoitre.vn')}}"><i class="fa fa-user-circle-o"></i>&nbsp;Thông tin cá
                            nhân</a></li>
                    <li><button style="background-color: transparent;border: none;padding: 0; margin: 0;font: inherit;cursor: pointer;outline: none;" id="clearCookieButton"><a  class="dropdown-item myf5"><i class="fa fa-sign-out"></i>&nbsp;
                          Đăng xuất
