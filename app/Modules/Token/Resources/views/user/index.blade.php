        ...
        <section class="mymain">
            ...
            <main>
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <button type="button" class="btn mybt1" id="btn-add-detail" data-bs-toggle="modal"
                                data-bs-target="#addDetail">Thêm user
                        </button>
                    </div>
                </div>
                <hr>
                ...
                <div>
                    <table class="table table-xs" id="mytable">
                        ...
                        <tr class="mt-3">
                            <th scope="col">
                                <a class="dropdown-toggle btn" href="#" role="button" data-bs-toggle="dropdown"
                                   aria-expanded="false">
                                    Username
                                </a>
                            </th>
                        ...
                        <tr id="btn-open-detail">
                            ...
                            <td>
                                <button type="button" class="btn btn-sm mybt3" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Update"><i class="fa fa-pencil-square-o"
                                                                                  aria-hidden="true"></i></button>
                                <button type="button" class="btn btn-sm mybt3" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Update" id="btn-confirm" data-bs-toggle="modal"
                                        data-bs-target="#confirm"><i class="fa fa-unlock-alt" aria-hidden="true"></i>
                                </button>
                            </td>
                        </tr>
                        <tr id="btn-open-detail">
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-sm mybt3" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Update" id="btn-confirm" data-bs-toggle="modal"
                                        data-bs-target="#confirm"><i class="fa fa-lock" aria-hidden="true"></i></button>
                            </td>
                        </tr>
                        <tr id="btn-open-detail">
                            <th scope="row">khang nguyen</th>
